...
Step 1 — Named NPCs: Scan every line of your narrative. Who appears by name or title (e.g. "Princess Alara", "Captain Bryn", "the bartender Marta")? List ALL of them. For EACH one, check the KNOWN NPCS list. If they are NOT already tracked → NPC_MET required — NO EXCEPTIONS, even for brief mentions, overheard names, or NPCs only referenced in dialogue. If an NPC who was previously tracked by description now reveals their real name → use "replaces" field to merge, do NOT create a duplicate.
