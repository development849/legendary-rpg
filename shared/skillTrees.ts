  ...
  fighter: [
    {
      ...
      pick: 1,
      choices: [
        { id: "extra_attack", name: "Extra Attack", description: "Strike twice when you take the Attack action.", mechanicalEffect: "+1 attack per turn" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "tactical_surge", name: "Tactical Surge", description: "Once per rest, take an additional action on your turn.", mechanicalEffect: "Bonus action per rest" },
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "indomitable", name: "Indomitable", description: "Reroll a failed saving throw once per rest.", mechanicalEffect: "Reroll 1 save per rest" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "unstoppable", name: "Unstoppable", description: "Once per day, when reduced to 0 HP, return to half health instead.", mechanicalEffect: "Cheat death 1/day" },
      ],
    },
  ],
  rogue: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "uncanny_dodge", name: "Uncanny Dodge", description: "Halve damage from an attack you can see coming.", mechanicalEffect: "Halve 1 attack's damage per round" },
      ],
    },
    {
      level: 15,
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "stroke_of_luck", name: "Stroke of Luck", description: "Turn any missed attack into a hit, or any failed check into a success, once per rest.", mechanicalEffect: "Auto-success 1/rest" },
      ],
    },
  ],
  wizard: [
    {
      ...
      choices: [
        ...
        { id: "counterspell", name: "Counterspell", description: "React instantly to negate an enemy's spell before it takes effect.", mechanicalEffect: "Cancel 1 enemy spell per round" },
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "time_stop", name: "Time Stop", description: "Briefly freeze time, allowing you to act while all others are frozen.", mechanicalEffect: "2 free actions per rest" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "wish", name: "Wish", description: "Channel raw magical force to reshape reality itself, once per day.", mechanicalEffect: "Wish spell 1/day" },
      ],
    },
  ],
  cleric: [
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "divine_intervention", name: "Divine Intervention", description: "Call upon your deity for a miraculous intervention in desperate times.", mechanicalEffect: "Call for divine aid 1/day" },
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "resurrection", name: "Resurrection", description: "Return a fallen ally to life, restoring them fully.", mechanicalEffect: "Revive 1 dead ally per day" },
        { id: "divine_shield", name: "Divine Shield", description: "An impenetrable barrier of holy light that blocks all damage for one round.", mechanicalEffect: "Immunity to damage for 1 round per rest" },
      ],
    },
    {
      level: 20,
      pick: 1,
      choices: [
        { id: "avatar", name: "Divine Avatar", description: "Channel your god's full power, becoming an avatar of divine might.", mechanicalEffect: "+4 to all stats, fly, radiant damage aura for 1 min/day" },
        { id: "miracle", name: "Miracle", description: "Your faith can move mountains. Perform one miracle per day.", mechanicalEffect: "Miracle spell 1/day" },
      ],
    },
  ],
  ranger: [
    {
      ...
      pick: 1,
      choices: [
        { id: "multishot", name: "Multishot", description: "Fire two arrows simultaneously at different targets.", mechanicalEffect: "2 ranged attacks per turn" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "swift_quiver", name: "Swift Quiver", description: "Your quiver never empties, and you fire with supernatural speed.", mechanicalEffect: "+2 bonus ranged attacks per turn" },
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "apex_predator", name: "Apex Predator", description: "You are the ultimate hunter. Your first attack each turn auto-hits.", mechanicalEffect: "First attack auto-hits each turn" },
  ...
  paladin: [
    {
      ...
      pick: 1,
      choices: [
        { id: "extra_attack_paladin", name: "Extra Attack", description: "Make two attacks when you take the Attack action.", mechanicalEffect: "+1 attack per turn" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "cleansing_touch", name: "Cleansing Touch", description: "End one spell effect on a willing creature with a touch.", mechanicalEffect: "Dispel 1 effect per rest" },
    ...
    },
    {
      ...
      pick: 1,
      choices: [
        { id: "celestial_form", name: "Celestial Form", description: "Sprout radiant wings and become a beacon of divine power.", mechanicalEffect: "Fly, +30 max HP, radiant aura for 1 min/day" },
  ...
  barbarian: [
    {
      ...
      pick: 1,
      choices: [
        { id: "extra_attack_barb", name: "Extra Attack", description: "Make two attacks when you take the Attack action.", mechanicalEffect: "+1 attack per turn" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "devastating_blow", name: "Devastating Blow", description: "Once per rage, deliver a blow so powerful it stuns the target.", mechanicalEffect: "Stun on hit 1/rage" },
      ],
    },
    {
      level: 20,
  ...
  bard: [
    {
      ...
      pick: 1,
      choices: [
        { id: "font_of_inspiration", name: "Font of Inspiration", description: "Your Bardic Inspiration dice recharge on a short rest.", mechanicalEffect: "Bardic Inspiration recharges on short rest" },
...
export const RACE_BONUS_SKILLS: Record<string, SkillOption[]> = {
  ...
  Dragonborn: [
    { id: "dragon_wings", name: "Dragon Wings", description: "Vestigial draconic wings grant short bursts of flight.", mechanicalEffect: "Fly 30ft as bonus action 1/rest" },
  ],
  Gnome: [
    { id: "gnome_inventor", name: "Gnomish Invention", description: "Craft a unique gadget that aids you in creative ways.", mechanicalEffect: "Create 1 utility gadget per day" },
  ],
  Aasimar: [
    { id: "celestial_radiance", name: "Celestial Radiance", description: "Your divine heritage manifests as a radiant transformation.", mechanicalEffect: "Radiant form: fly + 1d6 radiant damage aura for 1 min/day" },
  ],
  Tabaxi: [
    { id: "nine_lives", name: "Nine Lives", description: "Feline luck grants you a second chance at death's door.", mechanicalEffect: "Survive lethal damage 1/day at 1 HP" },
  ],
};
